...
const getSystemPrompt = () => {
  ...
  (1) one or more database table schemas that are already filtered for relevance, 
  (2) a user prompt describing a data retrieval request. 
  ...
  - The SELECT statement must be a simple string with no formatting, no back ticks, no quotes, just plain string. 
